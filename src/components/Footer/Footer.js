        ...
        <section>
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                ...
                                <li>
                                    <a href="#Telegram" className="hover:underline">Telegram</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                ...
                                <li className="mb-4">
                                    <a href="#Privacy-Policy" className="hover:underline">Licensingy</a>
                                </li>
                                <li>
                                    <a href="#Link" className="hover:underline">Terms &amp; Conditions</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/flowbite" className="hover:underline ">iso</a>
                                </li>
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Android</a>
                                </li>
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Windows</a>
                                </li>
                                <li>
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Linex</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <i>Developed by &copy; <span className="text-indigo-600">Ashim Bhowmik Amit </span>
                        2022</i>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="#Page" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
