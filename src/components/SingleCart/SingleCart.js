    ...
    return (
        <div className=' rounded-md relative bg-white mt-4 h-[600px]'>
            ...
            <div className='absolute bottom-0 left-8 mb-3'>
                <button className='  w-[300px] border-2  text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'>Add to list</button>
            </div>
        </div>
    );
};
